...
TEST(PawnSuite, PawnInMiddleFirstMove) {
    ...
    board[3][5] = new Square(new Pawn(PieceColor::BLACK), std::make_pair(3, 5));
...
TEST(BlackPawnSuite, PawnInMiddleFirstMove) {
    ...
    board[5][5] = new Square(new Pawn(PieceColor::WHITE), std::make_pair(5, 5));
...
TEST(PawnSuite, PawnInCorner) {
    ...
    board[6][6] = new Square(new Pawn(PieceColor::BLACK), std::make_pair(6, 6));
...
TEST(BlackPawnSuite, PawnInCorner) {
    ...
    board[1][1] = new Square(new Pawn(PieceColor::WHITE), std::make_pair(1, 1));
